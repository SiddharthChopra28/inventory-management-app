...
class Items
{
  public:
    ...
    const int64_t &getValueOfQuantity() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int64_t> &getQuantity() const noexcept;
    ///Set the value of the column quantity
    void setQuantity(const int64_t &pQuantity) noexcept;
    ...
    /**  For column imageURL  */
    ///Get the value of the column imageURL, returns the default value if the column is null
    const std::string &getValueOfImageurl() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getImageurl() const noexcept;
    ///Set the value of the column imageURL
  ...
  private:
    ...
    std::shared_ptr<int64_t> quantity_;
