      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          ...
          if (_selectedImage == null){
            ...
            context.read<ItemsAddEditBloc>().add(SubmitFormEvent(details: details_));
          }
          else{
            // need to pass the file in the event
            context.read<ItemsAddEditBloc>().add(SubmitFormEvent(details: details_, file: _selectedImage));
          }
